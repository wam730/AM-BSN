...
if __name__ == '__main__':
    ...
    args.add_argument('-rd', '--data_root_dir', default=r'/data/wyj/dataset', type=str)
    ...
    if args.dataset_name == 'SIDD':
        dataset_path = os.path.join(args.data_root_dir, 'SIDD/SIDD_Medium_Srgb')
        ...
        dataset_path = os.path.join(args.data_root_dir, 'DND/images_srgb')
